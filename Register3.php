...
<h2>Children’s stock registration and distrubation
        </h2>
         <label
for="name">date :</label>
          <input
type="date" id="dob" date="dob">
          <br><br>
           <label
for="name">particular’s:</label>
          <input
type="text" id="par" name="par">
          <br><br>
           <label
for="name">Recived from office /donation:</label>
          <input
type="text" id="rd" name="rd">
          <br><br>
           <label
for="name">Recived Quantity:</label>
          <input
type="text" id="rq" name="rq">
          <br><br>
           <label
for="name">Issued Quantity:</label>
          <input
type="text" id="iq" name="iq">
          <br><br>
           <label for="name">Balance Quantity:</label>
          <input
type="text" id="bq" name="bq">
          <br><br>
          <input
